...
namespace IdeaSite.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            IdeaSiteContext ideaSiteContext = new IdeaSiteContext();
            List<Comment> comments = ideaSiteContext.Comments.Where(com => com.ideaID == id).ToList();
        ...
        public ActionResult Create([Bind(Include = "ideaID,ideaName,userName,bodyOfComment,creationDate,ownerID,ownerIdea")] Comment comment, int id)
        {
